...
function App() {
 ...
 useEffect(() => {
  ...
  // strip code immediately — prevents double call on re-render
  ...
  const handleGithubLogin = () => {
    // Redirect to the backend login route, which handles the redirect to GitHub
  ...
  return (
    <div className="container">
      <div className="card">
        ...
        <p className="subtitle">Login to continue tracking your progress</p>
